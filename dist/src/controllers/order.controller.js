...
export const getCompletedOrdersOfAProduct = async (req, res) => {
    try {
...
export const getSellerAllOrdersWithFiltration = async (req, res) => {
    try {
        let { limit, page } = req.query;
        page = page ?? 1;
        limit = limit ?? 5;
...
export const getAllOrderListingsWithFiltration = async (req, res) => {
    try {
        let { limit, page } = req.query;
        page = page ?? 1;
        limit = limit ?? 5;
...
export const getSubscriptionOrdersOnlyWithFiltration = async (req, res) => {
    try {
...
export const orders_with_payment_status_payed = async (req, res) => {
    try {
        let { limit, page, end_date, start_date } = req.query;
        page = page ?? 1;
        limit = limit ?? 5;
        ...
        const orders = await Order.find(query, {}, { limit, skip })
