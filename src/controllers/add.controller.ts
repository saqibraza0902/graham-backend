...
export const getPostsAdd = async (req: Request, res: Response) => {
    try {
...
export const getUserPostsWithPagination = async (req: Request, res: Response) => {
    try {
        let { limit, page } = req.query as unknown as {
            page: number,
            limit: number
...
export const getProductWithOrdersStatuses = async (req: Request, res: Response) => {
    try {
