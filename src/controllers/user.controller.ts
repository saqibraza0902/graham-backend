...
import Add, { IAdd } from "../models/Add.model.js";
...
export const getSellersWithFiltration = async (req: Request, res: Response) => {
    try {
        ...
        const pipeline = [
            {
                $lookup: {
                    from: 'adds', // Name of the products collection
                    localField: '_id',
...
export const getBuyerWithFiltration = async (req: Request, res: Response) => {
    try {
        let { limit, page } = req.query as unknown as {
            page: number,
            limit: number
        ...
        const pipeline = [
            {
                $lookup: {
                    from: 'orders', // Name of the collection
                    localField: '_id',
                    foreignField: 'buyer',
                    as: 'products',
                },
            ...
            },
            {
                $lookup: {
                    from: 'adds', // Name of the products collection
                    localField: 'latestProduct.product', // Assuming this field contains the product ID
                    foreignField: '_id',
...
export const getSingleUserAllOrdersFiltration = async (req: Request, res: Response) => {
    try {
        // FILTERS.
        let { limit, page } = req.query as unknown as {
            page: number,
...
export const get_dashboard_analytics = async (req: Request, res: Response) => {
    try {
